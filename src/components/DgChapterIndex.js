                                                ...
                                                {item.childs.length > 0 ?
                                                    item.childs?.map((c, cIndex) => {
                                                        return (
                                                            ...
                                                            //------------------- new next--------------------- 
                                                            <div className='in-act-wrapper mt-2'>
                                                                <Link href={`/DGS/page/${c.page_id}`} className='det-para'><span>{c.chapter_name}</span></Link>
                                                                <div className='actions-mains'>
                                                                    <Link href={`/DGS/page/${c.page_id}`} className='det-no'><span >{c.page_id}</span></Link>
                                                                </div>
                                                            </div>
                                                        );
                                                    }) :
                                                    ...
                                                    //------------------- new next--------------------- 
                                                    <div className='in-act-wrapper mt-2'>
                                                        <Link href={`/DGS/page/${item.page_id}`} className='det-para'><span>{item.chapter_name}</span></Link>
                                                        <div className='actions-mains'>
                                                            <Link href={`/DGS/page/${item.page_id}`} className='det-no'><span >{item.page_id}</span></Link>
                                                        </div>
                                                    </div>
                                                }
                                            </details>
