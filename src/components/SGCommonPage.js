                    ...
                    <div className='row'>
                        ...
                        <div className='col-lg-12 d-flex-justify-content-end ang-ang  mt-3"'>
                            ...
                            <div className='audio-features mobile-issue'>
                               ...
                               {/*  <button className='action-btn-main mx-2' onClick={() => window.open(`/baanis/${props.apiName}/page/${headingData.current_page}/print-view`,'Bhai Nand Lal', '_blank', 'height=700,width=700')} ><i className="bi bi-printer"></i></button> */}
                                <button className='action-btn-main mx-2' onClick={() => window.open(`/sundar-gutka/${props.apiName}/page/${headingData.current_page}/print-view`,'Bhai Nand Lal', '_blank', 'height=700,width=700')} ><i className="bi bi-printer"></i></button>
