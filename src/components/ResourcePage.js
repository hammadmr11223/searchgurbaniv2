  ...
  const getAngByAng = async (pageNo) => {
    ...
    if (props.poet === "fwt" || "sggd") {
      await ApiHelper.get(
        ...
        .then((resData) => {
          console.log("object", resData.data);
          setLoader(false);
                ...
                <div className="actions-mains">
                  ...
                  {props.apiName === "sri-nanak-prakash" ? (
                    <button
                      ...
                      onClick={() =>
                        window.open(
                          `/Resources/SNP/page/${angNo}/volume/${volNo}/${
                            isHindi ? "Hindi" : "Punjabi"
                          }/print-view`,
                          "_blank",
                    ...
                    <button
                      ...
                      onClick={() =>
                        window.open(
                          `/Resources/SGPSG/page/${angNo}/volume/${volNo}/${
                            isHindi ? "Hindi" : "Punjabi"
                          }/print-view`,
                          "_blank",
                          "height=700,width=700"
                    ...
                    <button
                      ...
                      onClick={() =>
                        window.open(
                          `/Resources/FWT/page/${angNo}/volume/${volNo}/${
                            isHindi ? "Hindi" : "Punjabi"
                          }/print-view`,
                          "_blank",
                          "height=700,width=700"
                    ...
                    <button
                      ...
                      onClick={() =>
                        window.open(
                          `/Resources/SGGD/page/${angNo}/volume/${volNo}/${
                            isHindi ? "Hindi" : "Punjabi"
                          }/print-view`,
                          "_blank",
                          "height=700,width=700"
            ...
            <div className="col-lg-12 d-flex-justify-content-end ang-ang">
              <div className="go-to-ang position-relative">
                <div className="form-group">
                  <input
                    type="text"
                    placeholder="go to ang"
                    className="form-control"
                    onChange={(e) => setAngNo(e.target.value)}
                    value={angNo}
                  ></input>
                  <button
                    className="ang-btn"
              ...
              <div className="audio-features">
                <button
                  ...
                  onClick={(e) => {
                    e.preventDefault();
                    isHindi === false ? setIsHindi(true) : setIsHindi(false);
                  }}
                >
                  {isHindi === false ? "View in Hindi" : "View in Gurumukhi"}
                </button>
                {/* <button className='ang-btn' onClick={() => router.push(`/Resources/SNP/SNPrakash`)}>Search Page</button> */}
                {props.apiName === "sri-nanak-prakash" ? (
                  <button
                    className="ang-btn"
                    onClick={() => router.push(`/Resources/SNP/SNPrakash`)}
                  >
                    Search Page
                  </button>
                ) : props.apiName === "sri-gur-pratap-suraj-granth" ? (
                  <button
                    className="ang-btn"
                    onClick={() => router.push(`/Resources/SGPSG`)}
                  >
                    Search Page
                  </button>
                ) : 
                props.apiName === "sri-guru-granth-darpan" ? (
                  <button
                    className="ang-btn"
                    onClick={() => router.push(`/Resources/SGGD`)}
                  >
                    Search Page
                  </button>
                ) 
                ...
                : props.apiName === "faridkot-wala-teeka" ? (
                  ...
                  <button
                    ...
                    onClick={() =>
                      window.open(
                        `/sri-guru-granth-darpan/page/${angNo}/volume/${volNo}/${
                          isHindi ? "Hindi" : "Punjabi"
                        }/print-view`,
                        "_blank",
                        "height=700,width=700"
                ...
                {/*    {props.apiName !== "sri-guru-granth-darpan" ? (
                                    props.apiName !== "faridkot-wala-teeka" ? (
                                        <button
                                            ...
                                            onClick={(e) => {
                                                e.preventDefault();
                                                router.push(`/Resources/SNP/chapters/${volNo}`);
                                            }}
                                        >
                                            Chapter Index
                                        </button>
                                        ...
                                        <button
                                            ...
                                            onClick={(e) => {
                                                e.preventDefault();
                                                router.push(`/Resources/SNP/chapters`);
                                            }}
                                        >
                                            Chapter Index
                                        </button>
                ...
                {props.apiName === "sri-nanak-prakash" ? (
                  ...
                  <button
                    ...
                    onClick={(e) => {
                      e.preventDefault();
                      router.push(`/Resources/SGPSG/chapters/${volNo}`);
                    }}
                  >
                    Chapter Index
                  </button>
                  ...
                  <button
                    ...
                    onClick={(e) => {
                      e.preventDefault();
                      router.push(`/Resources/FWT/chapters`);
                    }}
                  >
                    Chapter Index
                  </button>
        ...
        <div className="container">
          <div className="d-flex flex-column">
            <div className="ang-display mt-5">
              <h1>
                Displaying Page {allData.page_no} of {allData.lines_count} from
                Volume {allData.volume_id}
              </h1>
              <div className="ang-wrapper">
                {angData.map((item, index) => {
                  ...
                  return (
                    <div
                      className={`ang-itm ${isCenter && "center-align"}`}
                      style={{ background: "#f5e8de" }}
                    >
                        ...
                        >
                          {item.text.split("\n").map((line, index) => (
                            <p
                              key={index}
                              className="snp-viwe"
                              style={{ fontSize: `${gurmukhiSize}px` }}
                            >
                              {line}
                            </p>
                          ))}
