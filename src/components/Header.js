          ...
          <ul className='d-flex sub-menu-wrapper' >
            ...
            {/* Amrit Keertan DropDown  */}
              <NavDropdown title="Amrit Keertan" id="navbarScrollingDropdown">
                ...
                <NavDropdown.Item as={Link} className={pathname === '/AK/pageByPage' ? 'active' : ''} href="/AK/pageByPage">
                  Page by Page
                </NavDropdown.Item>
                <NavDropdown.Item as={Link} className={pathname === '/AK/chapterIndex' ? 'active' : ''} href="/AK/chapterIndex">
                  Chapter Index
                </NavDropdown.Item>
                <NavDropdown.Item as={Link} className={pathname === '/AK/englishIndex' ? 'active' : ''} href="/AK/englishIndex">
                  English Index
                </NavDropdown.Item>
                <NavDropdown.Item as={Link} className={pathname === '/AK/punjabiIndex' ? 'active' : ''} href="/AK/punjabiIndex">
                  Punjabi Index
                </NavDropdown.Item>
                <NavDropdown.Item as={Link} className={pathname === '/AK/hindiIndex' ? 'active' : ''} href="/AK/hindiIndex">
                  Hindi Index
                </NavDropdown.Item>
                <NavDropdown.Item as={Link} className={pathname === '/AK/akSearch' ? 'active' : ''} href="/AK/akSearch">
            ...
            <li>
              <NavDropdown title="Bhai Gurdas Vaaran" id="navbarScrollingDropdown">
                <NavDropdown.Item as={Link} className={pathname === '/BGV' ? 'active' : ''} href="/BGV">
                  Introduction
                </NavDropdown.Item>
                <NavDropdown.Item as={Link} className={pathname === '/BGV/pauriByPauri' ? 'active' : ''} href="/BGV/pauriByPauri">
                  Pauri by Pauri
                </NavDropdown.Item>
                <NavDropdown.Item as={Link} className={pathname === '/BGV/vaarIndex' ? 'active' : ''} href="/BGV/vaarIndex">
                  Vaar Index
                </NavDropdown.Item>
                <NavDropdown.Item as={Link} className={pathname === '/BGV/BgvSearch' ? 'active' : ''} href="/BGV/BgvSearch">
            ...
            <li>
              <NavDropdown title="Bhai Nand Lal" id="navbarScrollingDropdown">
                ...
                <NavDropdown.Item as={Link} className={pathname === '/BNL/search' ? 'active' : ''} href="/BNL/search">
