                ...
                <div className="second-container intro-bkg">
                    <div className="row ">
                        ...
                        <div className='col-lg-12 d-flex center-align ang-ang mt-2 mb-3  mb-align p-0'>
                            <Link href={`/Resources/SGGD/page`}><div className='sub-head-snp'>Browse Page by Page Sri Guru Granth Sahib Darpan</div></Link>
                        ...
                        <div className='position-relative my-3'>
                            ...
                            />
                            <div class="input-group-append"><button class="btn btn-outline-secondary search-divz" type="button" onClick={() => input !== "" ? router.push(`/Resources/SGGD/search-preview?word=${encodeURIComponent(input)}`) : null}><i class="bi bi-search"></i></button></div>
                        </div>
