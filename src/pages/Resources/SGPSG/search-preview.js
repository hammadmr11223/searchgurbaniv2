                ...
                <div className='container'>
                    <div className='row'>
                        <div className='in-act-wrapper'>
                            <h2 className='text-dark mb-4'>Sri Gur Pratap Suraj Granth</h2>                            
                        </div>
                       <div className='in-act-wrapper'>                       
                            <h6 className='text-dark'>Showing from {pageData.showing_from} to {pageData.showing_to} of occurrences of {word} in Sri Gur Pratap Suraj Granth</h6>
                            ...
                            {searchData.length >1 ?
                               ...
                               { pageData.showing_to !== pageData.total_results ? <button className='ang-btn' onClick={() => handleNextClick(pageNo)}>Next</button> : null }
                                ...
                                <button className='ang-btn' onClick={() => router.push('/Resources/SGPSG')}>Search Page</button>
                            </div>
                        </div>
...
export default SgpsgSearchView