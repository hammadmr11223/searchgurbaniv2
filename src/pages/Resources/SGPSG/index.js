                ...
                <div className="second-container intro-bkg">
                    <div className="row ">
                        ...
                        <div className='col-lg-12 d-flex-justify-content-end ang-ang mt-2 mb-3 mb-align p-0 '>
                            <Link href={`/Resources/SGPSG/SGPSGVolume`}><div className='sub-head-snp'>Volume Index</div></Link>
                            <Link href={`/Resources/SGPSG/page`}><div className='sub-head-snp'>Browse Page by Page</div></Link>
                        </div>
                        ...
                        <div class="input-group-append"><button class="btn btn-outline-secondary search-divz" type="button" 
                              onClick={() => input !== '' ? router.push(`/Resources/SGPSG/search-preview?word=${encodeURIComponent(input)}`) : null}
