...
function Mahankosh() {
    ...
    // };
     const handleAlphaClick = (alpha) => {
    router.push(`/Resources/GSRM/MahankoshView?word=${encodeURIComponent(alpha)}`);
  };
    ...
    return (
        <div>
             <Head>
                          ...
                          <meta name="description" content={searchData?.description} />
                          <meta name="keywords" content={searchData?.keywords} />
                          <meta property="og:title" content={searchData?.title} />
                          <meta property="og:description" content={searchData?.description} />
      ...
      <button
        ...
        type="button"
        onClick={() => input !== '' ? router.push(`/Resources/GSRM/MahankoshView?word=${encodeURIComponent(input)}`) : null}
      >
