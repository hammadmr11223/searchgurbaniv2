                ...
                <div className="second-container intro-bkg">
                    <div className="row ">
                        ...
                        <div className='col-lg-12 d-flex-justify-content-end ang-ang mt-2 mb-3 mb-align p-0'>
                            <Link href={`/Resources/FWT/page`}><div className='sub-head-snp'>Browse Page by Page Faridkot Wala Teeka</div></Link>
                            <Link href={`/Resources/FWT/chapters`}><div className='sub-head-snp'>Chapter Index Faridkot Wala Teeka</div></Link>
                        </div>
                        ...
                        <div className='position-relative my-3'>
                          ...
                          {/*   <div class="input-group-append"><button class="btn btn-outline-secondary search-divz" type="button" onClick={() => input !== "" ? navigate('/faridkot-wala-teeka/search-preview', { state: { Word: input } }) : null}><i class="bi bi-search"></i></button></div> */}
                            <div class="input-group-append"><button class="btn btn-outline-secondary search-divz" type="button" onClick={() => input !== "" ? router.push(`/Resources/FWT/search-preview?word=${encodeURIComponent(input)}`) : null}><i class="bi bi-search"></i></button></div>
                        </div>
