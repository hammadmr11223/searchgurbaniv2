   ...
   const router = useRouter()
    ...
    const handleAlphaClick = (alpha) => {
      //  navigate('/maansarovar/words', { state: { Word: alpha } })
           router.push(`/Resources/Maansarovar/words?word=${encodeURIComponent(alpha)}`) 
    };
    ...
    return (
        <div>
                ...
                <div className="second-container intro-bkg">
                    <div className="row ">
                        ...
                        <ul className='letters' >
                            {alphas.map((alpha) => (
                                <li onClick={() => handleAlphaClick(alpha)} ><a><b>{alpha}</b></a></li>
                            ))}

                        </ul>
                        <h6 className='text-dark text-center' >Browse by letter</h6>
                        <h1 className='text-dark text-center' >Maansarovar</h1>
                        <p className='inner-heading text-center text-dark' >A valuable document compiled by Dr. Kulwant Singh with a collection of
                            about 7000 quotations from Siri Guru Granth Sahib organized by subject matter.</p>

                        <h4 className='inner-heading text-center text-dark' > Maansarovar</h4>
                        <div className='position-relative my-3'>
                            ...
                            <div class="input-group-append"><button class="btn btn-outline-secondary search-divz" type="button" onClick={() => input !== "" ?  router.push(`/Resources/Maansarovar/words?word=${encodeURIComponent(input)}`) : null}><i class="bi bi-search"></i></button></div>
                        </div>

                    </div>

                    <section className='col-lg-12 p-3'>
                <div className='container'>
                    <div className=' p-4'>
            ...
            <section className='col-lg-12 browse_by_letter p-5'>
                <div className='container'>
                <p className='inner-heading  text-dark' >It was first published in 1930 after many years of painstaking
                    research from 1912 to 1927. Mahan Kosh as it is generally called is a model encyclopaedia. It modestly
                    claims in it subtitle to be an encyclopaedia of Sikh literature, but it is, in fact, much more.
                    Its remarkable coverage and exemplary accuracy has a multitude of entries ranging from brief definitions
                    of difficult words from the scriptures and tradition, through descriptive notes on various doctrines,
                    individuals and institutions to accounts of the Gurus. It gives careful treatment of ter-minology,
                ...
                <p className='inner-heading  text-dark' >The Mahan Kosh is indispensable for any serious student of Sikh studies,
                    ...
                    Bhai Kahn Singh ranks as one of the modern world's greatest encyclopaedists. The fact that he
                    chose to present all his work in Punjabi has limited his contribution to those who are able to read
                    Punjabi, and although his reputation extends much farther, it is largely confined to the general area
                    of Sikh studies. This does him less than justice. The range of his coverage, the meticulous care with
                    which he collected and arranged his material, a scrupulous concern for accuracy and the succinct nature
                    of his presentation, distinguishes his work. These are the qualities of a great encyclopaedist and their
                    manifest presence in the works of Bhai Kahn Singh qualifies him as one of the truly great theologians.</p>
