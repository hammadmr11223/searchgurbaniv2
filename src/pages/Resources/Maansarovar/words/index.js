                    ...
                    <div className='row'>
                        ...
                        <div className='in-act-wrapper'>
                            ...
                            <div className='actions-mains'>
                                <button className='ang-btn' onClick={() => router.push('/Resources/Maansarovar')}>Search Page</button>
                            </div>
                        </div>
                        ...
                        <div className='ang-display '>
                            <div className="words-grid">
                                {searchData.map((item, index) => (
                                        /*  <Link href={`/Resources/Maansarovar/quotations/?word=${encodeURIComponent(word)}`}> */
                                   <Link href={`/Resources/Maansarovar/quotations/${encodeURIComponent(item.word)}`}>
