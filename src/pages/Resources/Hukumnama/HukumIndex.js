                                            ...
                                            <details>
                                                ...
                                                {item.childs?.map((c, cIndex) => (
                                                    ...
                                                    <div className='in-act-wrapper mt-2'>
                                                        <Link  href={`/Resources/Hukumnama/ang/${c.pageno}`} className='det-para-huku'><span>{c.title}</span></Link>
                                                        <div className='actions-mains'>
                                                            <Link href={`/Resources/Hukumnama/ang/${c.pageno}`} className='det-no hukum-indx-no resps-humku'><span >{parseInt(c.pageno)}</span></Link>
                                                        </div>
                                                    </div>
