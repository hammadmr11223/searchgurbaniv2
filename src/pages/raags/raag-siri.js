...
function SriRaag() {
    ...
    const getRaags = async () => {
        await Axios.get('https://backend.searchgurbani.com/api/meta?url=raags/raag-siri')
            .then((resData) => {
    ...
    const getAngByAngAudio = async () => {
        setLoader(true)
        await ApiHelper.get(API.getAngByAngAudio + "?path=raags/raag_siri")
            .then((resData) => {
                setLoader(false);
    ...
    return (
        <div>
            ...
            <section className='section-1'>
                ...
                <div className='Gurbani-Raags p-4 bg-light'>
